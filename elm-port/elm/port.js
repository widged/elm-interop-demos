...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var stringSignal = Elm.Native.Port.make(_elm).inboundSignal("stringSignal",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var upperCase = function (str) {    return $String.toUpper(str);};
   var convertedStringAddress = Elm.Native.Port.make(_elm).outboundSignal("convertedStringAddress",
   function (v) {
      return v;
   },
   A2($Signal.map,upperCase,stringSignal));
   return _elm.Main.values = {_op: _op,upperCase: upperCase};
};
